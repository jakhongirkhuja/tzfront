<template>
    <form class="row g-3 needs-validation" ref="form" @submit.prevent="checkForm" novalidate>
      <div class="col-md-12 position-relative">
        ...
        <input type="text" class="form-control" v-model="title" id="validationTooltip01" required />
        <div class="invalid-feedback">Please provide a title.</div>
      </div>
      <div class="col-md-12 position-relative">
        <label for="validationTooltip02" class="form-label">Slug</label>
        <input type="text" class="form-control" v-model="slug" id="validationTooltip02" readonly required />
      ...
      <div class="col-md-12 position-relative">
        ...
        <div class="input-group has-validation">
          <input type="text" class="form-control" v-model="keywords" id="validationTooltipKeywords" required />
          <div class="invalid-feedback">Please provide keywords.</div>
        </div>
      </div>
      <h5 class="card-title">Content</h5>
      <Editor required v-model="editorContent" api-key="98rflj1mxxvlq4fjga2n5edc4jiqvpwp3qvdf9yz2t08991g" :init="{
